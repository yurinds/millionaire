...
RSpec.describe GamesController, type: :controller do
  ...
  context 'Usual user' do
    ...
    it 'try to create second game' do
      ...
      another_game = FactoryBot.build(:game_with_questions, user: user)

      post :create, id: another_game.id
    ...
    it '#take_money' do
      # отвечаем на один вопрос и забираем деньги
      ...
      expect(game.prize).to eq(Game::PRIZES[game_w_questions.previous_level])
